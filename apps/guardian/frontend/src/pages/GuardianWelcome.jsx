...
export default function GuardianWelcome({ demo = false }) {
  return <div className="cg-public">
    <header className="cg-public-header"><a href="/welcome" aria-label="Sillage home"><GuardianWordmark /></a><nav aria-label="Public navigation"><a href="/welcome#how-it-works">How it works</a><a href="/demo" aria-current={demo ? 'page' : undefined}>Interactive demo</a><a href="/signin">Sign in <ArrowUpRight size={14} /></a></nav><a className="cg-button-primary cg-header-cta" href="/setup">Connect your app <ArrowRight size={15} /></a></header>
    <main>
      ...
      <section className="cg-start"><div><p className="cg-eyebrow">FROM EXPLORING TO OBSERVING</p><h2>Connect your first application.</h2><p>Have workspace access? Sign in and follow the connection guide.<br />New to this deployment? Your workspace owner sets up your access.</p></div><a className="cg-button-primary" href="/setup">Start connecting <ChevronRight size={17} /></a></section>
    </main>
    <footer className="cg-public-footer"><GuardianWordmark /><span>The wake your AI leaves behind. Evidence you can inspect.</span><a href="/signin">Open your workspace <ArrowUpRight size={14} /></a></footer>
  </div>;
}
